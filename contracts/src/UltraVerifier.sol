...
uint256 constant VK_HASH = 0x232db14b16699768baab69eaa1b916e05b3bb46b8a49ea4aba0217a3750b3b70;
uint256 constant CIRCUIT_SIZE = 16384;
uint256 constant LOG_N = 14;
uint256 constant NUMBER_PUBLIC_INPUTS = 22;
uint256 constant REAL_NUMBER_PUBLIC_INPUTS = 22 - 16;
uint256 constant PUBLIC_INPUTS_OFFSET = 1;
// LOG_N * 8
uint256 constant NUMBER_OF_BARYCENTRIC_INVERSES = 112;
...
/*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
uint256 internal constant GEMINI_A_EVAL_0 = 0x31c0;
uint256 internal constant GEMINI_A_EVAL_1 = 0x31e0;
uint256 internal constant GEMINI_A_EVAL_2 = 0x3200;
uint256 internal constant GEMINI_A_EVAL_3 = 0x3220;
uint256 internal constant GEMINI_A_EVAL_4 = 0x3240;
uint256 internal constant GEMINI_A_EVAL_5 = 0x3260;
uint256 internal constant GEMINI_A_EVAL_6 = 0x3280;
uint256 internal constant GEMINI_A_EVAL_7 = 0x32a0;
uint256 internal constant GEMINI_A_EVAL_8 = 0x32c0;
uint256 internal constant GEMINI_A_EVAL_9 = 0x32e0;
uint256 internal constant GEMINI_A_EVAL_10 = 0x3300;
uint256 internal constant GEMINI_A_EVAL_11 = 0x3320;
uint256 internal constant GEMINI_A_EVAL_12 = 0x3340;
uint256 internal constant GEMINI_A_EVAL_13 = 0x3360;
uint256 internal constant SHPLONK_Q_X_LOC = 0x3380;
uint256 internal constant SHPLONK_Q_Y_LOC = 0x33a0;
uint256 internal constant KZG_QUOTIENT_X_LOC = 0x33c0;
uint256 internal constant KZG_QUOTIENT_Y_LOC = 0x33e0;
...
/*                                            CHALLENGES                                            */
/*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
uint256 internal constant ETA_CHALLENGE = 0x3400;
uint256 internal constant ETA_TWO_CHALLENGE = 0x3420;
uint256 internal constant ETA_THREE_CHALLENGE = 0x3440;
uint256 internal constant BETA_CHALLENGE = 0x3460;
uint256 internal constant GAMMA_CHALLENGE = 0x3480;
uint256 internal constant RHO_CHALLENGE = 0x34a0;
uint256 internal constant GEMINI_R_CHALLENGE = 0x34c0;
uint256 internal constant SHPLONK_NU_CHALLENGE = 0x34e0;
uint256 internal constant SHPLONK_Z_CHALLENGE = 0x3500;
uint256 internal constant PUBLIC_INPUTS_DELTA_NUMERATOR_CHALLENGE = 0x3520;
uint256 internal constant PUBLIC_INPUTS_DELTA_DENOMINATOR_CHALLENGE = 0x3540;
uint256 internal constant ALPHA_CHALLENGE_0 = 0x3560;
uint256 internal constant ALPHA_CHALLENGE_1 = 0x3580;
uint256 internal constant ALPHA_CHALLENGE_2 = 0x35a0;
uint256 internal constant ALPHA_CHALLENGE_3 = 0x35c0;
uint256 internal constant ALPHA_CHALLENGE_4 = 0x35e0;
uint256 internal constant ALPHA_CHALLENGE_5 = 0x3600;
uint256 internal constant ALPHA_CHALLENGE_6 = 0x3620;
uint256 internal constant ALPHA_CHALLENGE_7 = 0x3640;
uint256 internal constant ALPHA_CHALLENGE_8 = 0x3660;
uint256 internal constant ALPHA_CHALLENGE_9 = 0x3680;
uint256 internal constant ALPHA_CHALLENGE_10 = 0x36a0;
uint256 internal constant ALPHA_CHALLENGE_11 = 0x36c0;
uint256 internal constant ALPHA_CHALLENGE_12 = 0x36e0;
uint256 internal constant ALPHA_CHALLENGE_13 = 0x3700;
uint256 internal constant ALPHA_CHALLENGE_14 = 0x3720;
uint256 internal constant ALPHA_CHALLENGE_15 = 0x3740;
uint256 internal constant ALPHA_CHALLENGE_16 = 0x3760;
uint256 internal constant ALPHA_CHALLENGE_17 = 0x3780;
uint256 internal constant ALPHA_CHALLENGE_18 = 0x37a0;
uint256 internal constant ALPHA_CHALLENGE_19 = 0x37c0;
uint256 internal constant ALPHA_CHALLENGE_20 = 0x37e0;
uint256 internal constant ALPHA_CHALLENGE_21 = 0x3800;
uint256 internal constant ALPHA_CHALLENGE_22 = 0x3820;
uint256 internal constant ALPHA_CHALLENGE_23 = 0x3840;
uint256 internal constant ALPHA_CHALLENGE_24 = 0x3860;
uint256 internal constant ALPHA_CHALLENGE_25 = 0x3880;
uint256 internal constant ALPHA_CHALLENGE_26 = 0x38a0;
uint256 internal constant GATE_CHALLENGE_0 = 0x38c0;
uint256 internal constant GATE_CHALLENGE_1 = 0x38e0;
uint256 internal constant GATE_CHALLENGE_2 = 0x3900;
uint256 internal constant GATE_CHALLENGE_3 = 0x3920;
uint256 internal constant GATE_CHALLENGE_4 = 0x3940;
uint256 internal constant GATE_CHALLENGE_5 = 0x3960;
uint256 internal constant GATE_CHALLENGE_6 = 0x3980;
uint256 internal constant GATE_CHALLENGE_7 = 0x39a0;
uint256 internal constant GATE_CHALLENGE_8 = 0x39c0;
uint256 internal constant GATE_CHALLENGE_9 = 0x39e0;
uint256 internal constant GATE_CHALLENGE_10 = 0x3a00;
uint256 internal constant GATE_CHALLENGE_11 = 0x3a20;
uint256 internal constant GATE_CHALLENGE_12 = 0x3a40;
uint256 internal constant GATE_CHALLENGE_13 = 0x3a60;
uint256 internal constant SUM_U_CHALLENGE_0 = 0x3a80;
uint256 internal constant SUM_U_CHALLENGE_1 = 0x3aa0;
uint256 internal constant SUM_U_CHALLENGE_2 = 0x3ac0;
uint256 internal constant SUM_U_CHALLENGE_3 = 0x3ae0;
uint256 internal constant SUM_U_CHALLENGE_4 = 0x3b00;
uint256 internal constant SUM_U_CHALLENGE_5 = 0x3b20;
uint256 internal constant SUM_U_CHALLENGE_6 = 0x3b40;
uint256 internal constant SUM_U_CHALLENGE_7 = 0x3b60;
uint256 internal constant SUM_U_CHALLENGE_8 = 0x3b80;
uint256 internal constant SUM_U_CHALLENGE_9 = 0x3ba0;
uint256 internal constant SUM_U_CHALLENGE_10 = 0x3bc0;
uint256 internal constant SUM_U_CHALLENGE_11 = 0x3be0;
uint256 internal constant SUM_U_CHALLENGE_12 = 0x3c00;
uint256 internal constant SUM_U_CHALLENGE_13 = 0x3c20;
...
/*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
uint256 internal constant SUBRELATION_EVAL_0_LOC = 0x3c40;
uint256 internal constant SUBRELATION_EVAL_1_LOC = 0x3c60;
uint256 internal constant SUBRELATION_EVAL_2_LOC = 0x3c80;
uint256 internal constant SUBRELATION_EVAL_3_LOC = 0x3ca0;
uint256 internal constant SUBRELATION_EVAL_4_LOC = 0x3cc0;
uint256 internal constant SUBRELATION_EVAL_5_LOC = 0x3ce0;
uint256 internal constant SUBRELATION_EVAL_6_LOC = 0x3d00;
uint256 internal constant SUBRELATION_EVAL_7_LOC = 0x3d20;
uint256 internal constant SUBRELATION_EVAL_8_LOC = 0x3d40;
uint256 internal constant SUBRELATION_EVAL_9_LOC = 0x3d60;
uint256 internal constant SUBRELATION_EVAL_10_LOC = 0x3d80;
uint256 internal constant SUBRELATION_EVAL_11_LOC = 0x3da0;
uint256 internal constant SUBRELATION_EVAL_12_LOC = 0x3dc0;
uint256 internal constant SUBRELATION_EVAL_13_LOC = 0x3de0;
uint256 internal constant SUBRELATION_EVAL_14_LOC = 0x3e00;
uint256 internal constant SUBRELATION_EVAL_15_LOC = 0x3e20;
uint256 internal constant SUBRELATION_EVAL_16_LOC = 0x3e40;
uint256 internal constant SUBRELATION_EVAL_17_LOC = 0x3e60;
uint256 internal constant SUBRELATION_EVAL_18_LOC = 0x3e80;
uint256 internal constant SUBRELATION_EVAL_19_LOC = 0x3ea0;
uint256 internal constant SUBRELATION_EVAL_20_LOC = 0x3ec0;
uint256 internal constant SUBRELATION_EVAL_21_LOC = 0x3ee0;
uint256 internal constant SUBRELATION_EVAL_22_LOC = 0x3f00;
uint256 internal constant SUBRELATION_EVAL_23_LOC = 0x3f20;
uint256 internal constant SUBRELATION_EVAL_24_LOC = 0x3f40;
uint256 internal constant SUBRELATION_EVAL_25_LOC = 0x3f60;
uint256 internal constant SUBRELATION_EVAL_26_LOC = 0x3f80;
uint256 internal constant SUBRELATION_EVAL_27_LOC = 0x3fa0;
...
/*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
uint256 internal constant FINAL_ROUND_TARGET_LOC = 0x3fc0;
uint256 internal constant POW_PARTIAL_EVALUATION_LOC = 0x3fe0;
uint256 internal constant AUX_NON_NATIVE_FIELD_IDENTITY = 0x4000;
uint256 internal constant AUX_LIMB_ACCUMULATOR_IDENTITY = 0x4020;
uint256 internal constant AUX_RAM_CONSISTENCY_CHECK_IDENTITY = 0x4040;
uint256 internal constant AUX_ROM_CONSISTENCY_CHECK_IDENTITY = 0x4060;
uint256 internal constant AUX_MEMORY_CHECK_IDENTITY = 0x4080;
...
uint256 internal constant POWERS_OF_EVALUATION_CHALLENGE_0_LOC = 0x40a0;
uint256 internal constant POWERS_OF_EVALUATION_CHALLENGE_1_LOC = 0x40c0;
uint256 internal constant POWERS_OF_EVALUATION_CHALLENGE_2_LOC = 0x40e0;
uint256 internal constant POWERS_OF_EVALUATION_CHALLENGE_3_LOC = 0x4100;
uint256 internal constant POWERS_OF_EVALUATION_CHALLENGE_4_LOC = 0x4120;
uint256 internal constant POWERS_OF_EVALUATION_CHALLENGE_5_LOC = 0x4140;
uint256 internal constant POWERS_OF_EVALUATION_CHALLENGE_6_LOC = 0x4160;
uint256 internal constant POWERS_OF_EVALUATION_CHALLENGE_7_LOC = 0x4180;
uint256 internal constant POWERS_OF_EVALUATION_CHALLENGE_8_LOC = 0x41a0;
uint256 internal constant POWERS_OF_EVALUATION_CHALLENGE_9_LOC = 0x41c0;
uint256 internal constant POWERS_OF_EVALUATION_CHALLENGE_10_LOC = 0x41e0;
uint256 internal constant POWERS_OF_EVALUATION_CHALLENGE_11_LOC = 0x4200;
uint256 internal constant POWERS_OF_EVALUATION_CHALLENGE_12_LOC = 0x4220;
uint256 internal constant POWERS_OF_EVALUATION_CHALLENGE_13_LOC = 0x4240;
...
/*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
uint256 internal constant BATCH_SCALAR_0_LOC = 0x4260;
uint256 internal constant BATCH_SCALAR_1_LOC = 0x4280;
uint256 internal constant BATCH_SCALAR_2_LOC = 0x42a0;
uint256 internal constant BATCH_SCALAR_3_LOC = 0x42c0;
uint256 internal constant BATCH_SCALAR_4_LOC = 0x42e0;
uint256 internal constant BATCH_SCALAR_5_LOC = 0x4300;
uint256 internal constant BATCH_SCALAR_6_LOC = 0x4320;
uint256 internal constant BATCH_SCALAR_7_LOC = 0x4340;
uint256 internal constant BATCH_SCALAR_8_LOC = 0x4360;
uint256 internal constant BATCH_SCALAR_9_LOC = 0x4380;
uint256 internal constant BATCH_SCALAR_10_LOC = 0x43a0;
uint256 internal constant BATCH_SCALAR_11_LOC = 0x43c0;
uint256 internal constant BATCH_SCALAR_12_LOC = 0x43e0;
uint256 internal constant BATCH_SCALAR_13_LOC = 0x4400;
uint256 internal constant BATCH_SCALAR_14_LOC = 0x4420;
uint256 internal constant BATCH_SCALAR_15_LOC = 0x4440;
uint256 internal constant BATCH_SCALAR_16_LOC = 0x4460;
uint256 internal constant BATCH_SCALAR_17_LOC = 0x4480;
uint256 internal constant BATCH_SCALAR_18_LOC = 0x44a0;
uint256 internal constant BATCH_SCALAR_19_LOC = 0x44c0;
uint256 internal constant BATCH_SCALAR_20_LOC = 0x44e0;
uint256 internal constant BATCH_SCALAR_21_LOC = 0x4500;
uint256 internal constant BATCH_SCALAR_22_LOC = 0x4520;
uint256 internal constant BATCH_SCALAR_23_LOC = 0x4540;
uint256 internal constant BATCH_SCALAR_24_LOC = 0x4560;
uint256 internal constant BATCH_SCALAR_25_LOC = 0x4580;
uint256 internal constant BATCH_SCALAR_26_LOC = 0x45a0;
uint256 internal constant BATCH_SCALAR_27_LOC = 0x45c0;
uint256 internal constant BATCH_SCALAR_28_LOC = 0x45e0;
uint256 internal constant BATCH_SCALAR_29_LOC = 0x4600;
uint256 internal constant BATCH_SCALAR_30_LOC = 0x4620;
uint256 internal constant BATCH_SCALAR_31_LOC = 0x4640;
uint256 internal constant BATCH_SCALAR_32_LOC = 0x4660;
uint256 internal constant BATCH_SCALAR_33_LOC = 0x4680;
uint256 internal constant BATCH_SCALAR_34_LOC = 0x46a0;
uint256 internal constant BATCH_SCALAR_35_LOC = 0x46c0;
uint256 internal constant BATCH_SCALAR_36_LOC = 0x46e0;
uint256 internal constant BATCH_SCALAR_37_LOC = 0x4700;
uint256 internal constant BATCH_SCALAR_38_LOC = 0x4720;
uint256 internal constant BATCH_SCALAR_39_LOC = 0x4740;
uint256 internal constant BATCH_SCALAR_40_LOC = 0x4760;
uint256 internal constant BATCH_SCALAR_41_LOC = 0x4780;
uint256 internal constant BATCH_SCALAR_42_LOC = 0x47a0;
uint256 internal constant BATCH_SCALAR_43_LOC = 0x47c0;
uint256 internal constant BATCH_SCALAR_44_LOC = 0x47e0;
uint256 internal constant BATCH_SCALAR_45_LOC = 0x4800;
uint256 internal constant BATCH_SCALAR_46_LOC = 0x4820;
uint256 internal constant BATCH_SCALAR_47_LOC = 0x4840;
uint256 internal constant BATCH_SCALAR_48_LOC = 0x4860;
uint256 internal constant BATCH_SCALAR_49_LOC = 0x4880;
uint256 internal constant BATCH_SCALAR_50_LOC = 0x48a0;
uint256 internal constant BATCH_SCALAR_51_LOC = 0x48c0;
uint256 internal constant BATCH_SCALAR_52_LOC = 0x48e0;
uint256 internal constant BATCH_SCALAR_53_LOC = 0x4900;
uint256 internal constant BATCH_SCALAR_54_LOC = 0x4920;
uint256 internal constant BATCH_SCALAR_55_LOC = 0x4940;
uint256 internal constant BATCH_SCALAR_56_LOC = 0x4960;
uint256 internal constant BATCH_SCALAR_57_LOC = 0x4980;
uint256 internal constant BATCH_SCALAR_58_LOC = 0x49a0;
uint256 internal constant BATCH_SCALAR_59_LOC = 0x49c0;
uint256 internal constant BATCH_SCALAR_60_LOC = 0x49e0;
uint256 internal constant BATCH_SCALAR_61_LOC = 0x4a00;
uint256 internal constant BATCH_SCALAR_62_LOC = 0x4a20;
uint256 internal constant BATCH_SCALAR_63_LOC = 0x4a40;
uint256 internal constant BATCH_SCALAR_64_LOC = 0x4a60;
uint256 internal constant BATCH_SCALAR_65_LOC = 0x4a80;
uint256 internal constant BATCH_SCALAR_66_LOC = 0x4aa0;
uint256 internal constant BATCH_SCALAR_67_LOC = 0x4ac0;
uint256 internal constant BATCH_SCALAR_68_LOC = 0x4ae0;
...
uint256 internal constant BATCH_EVALUATION_ACCUMULATOR_INVERSION_0_LOC = 0x2e0;
uint256 internal constant BATCH_EVALUATION_ACCUMULATOR_INVERSION_1_LOC = 0x300;
uint256 internal constant BATCH_EVALUATION_ACCUMULATOR_INVERSION_2_LOC = 0x320;
uint256 internal constant BATCH_EVALUATION_ACCUMULATOR_INVERSION_3_LOC = 0x340;
uint256 internal constant BATCH_EVALUATION_ACCUMULATOR_INVERSION_4_LOC = 0x360;
uint256 internal constant BATCH_EVALUATION_ACCUMULATOR_INVERSION_5_LOC = 0x380;
uint256 internal constant BATCH_EVALUATION_ACCUMULATOR_INVERSION_6_LOC = 0x3a0;
uint256 internal constant BATCH_EVALUATION_ACCUMULATOR_INVERSION_7_LOC = 0x3c0;
uint256 internal constant BATCH_EVALUATION_ACCUMULATOR_INVERSION_8_LOC = 0x3e0;
uint256 internal constant BATCH_EVALUATION_ACCUMULATOR_INVERSION_9_LOC = 0x400;
uint256 internal constant BATCH_EVALUATION_ACCUMULATOR_INVERSION_10_LOC = 0x420;
uint256 internal constant BATCH_EVALUATION_ACCUMULATOR_INVERSION_11_LOC = 0x440;
uint256 internal constant BATCH_EVALUATION_ACCUMULATOR_INVERSION_12_LOC = 0x460;
uint256 internal constant BATCH_EVALUATION_ACCUMULATOR_INVERSION_13_LOC = 0x480;

uint256 internal constant BATCHED_EVALUATION_LOC = 0x4a0;
uint256 internal constant CONSTANT_TERM_ACCUMULATOR_LOC = 0x4c0;

uint256 internal constant POS_INVERTED_DENOMINATOR = 0x4e0;
uint256 internal constant NEG_INVERTED_DENOMINATOR = 0x500;

// LOG_N challenge pow minus u
uint256 internal constant INVERTED_CHALLENEGE_POW_MINUS_U_0_LOC = 0x520;
uint256 internal constant INVERTED_CHALLENEGE_POW_MINUS_U_1_LOC = 0x540;
uint256 internal constant INVERTED_CHALLENEGE_POW_MINUS_U_2_LOC = 0x560;
uint256 internal constant INVERTED_CHALLENEGE_POW_MINUS_U_3_LOC = 0x580;
uint256 internal constant INVERTED_CHALLENEGE_POW_MINUS_U_4_LOC = 0x5a0;
uint256 internal constant INVERTED_CHALLENEGE_POW_MINUS_U_5_LOC = 0x5c0;
uint256 internal constant INVERTED_CHALLENEGE_POW_MINUS_U_6_LOC = 0x5e0;
uint256 internal constant INVERTED_CHALLENEGE_POW_MINUS_U_7_LOC = 0x600;
uint256 internal constant INVERTED_CHALLENEGE_POW_MINUS_U_8_LOC = 0x620;
uint256 internal constant INVERTED_CHALLENEGE_POW_MINUS_U_9_LOC = 0x640;
uint256 internal constant INVERTED_CHALLENEGE_POW_MINUS_U_10_LOC = 0x660;
uint256 internal constant INVERTED_CHALLENEGE_POW_MINUS_U_11_LOC = 0x680;
uint256 internal constant INVERTED_CHALLENEGE_POW_MINUS_U_12_LOC = 0x6a0;
uint256 internal constant INVERTED_CHALLENEGE_POW_MINUS_U_13_LOC = 0x6c0;

// LOG_N pos_inverted_off
uint256 internal constant POS_INVERTED_DENOM_0_LOC = 0x6e0;
uint256 internal constant POS_INVERTED_DENOM_1_LOC = 0x700;
uint256 internal constant POS_INVERTED_DENOM_2_LOC = 0x720;
uint256 internal constant POS_INVERTED_DENOM_3_LOC = 0x740;
uint256 internal constant POS_INVERTED_DENOM_4_LOC = 0x760;
uint256 internal constant POS_INVERTED_DENOM_5_LOC = 0x780;
uint256 internal constant POS_INVERTED_DENOM_6_LOC = 0x7a0;
uint256 internal constant POS_INVERTED_DENOM_7_LOC = 0x7c0;
uint256 internal constant POS_INVERTED_DENOM_8_LOC = 0x7e0;
uint256 internal constant POS_INVERTED_DENOM_9_LOC = 0x800;
uint256 internal constant POS_INVERTED_DENOM_10_LOC = 0x820;
uint256 internal constant POS_INVERTED_DENOM_11_LOC = 0x840;
uint256 internal constant POS_INVERTED_DENOM_12_LOC = 0x860;
uint256 internal constant POS_INVERTED_DENOM_13_LOC = 0x880;

// LOG_N neg_inverted_off
uint256 internal constant NEG_INVERTED_DENOM_0_LOC = 0x8a0;
uint256 internal constant NEG_INVERTED_DENOM_1_LOC = 0x8c0;
uint256 internal constant NEG_INVERTED_DENOM_2_LOC = 0x8e0;
uint256 internal constant NEG_INVERTED_DENOM_3_LOC = 0x900;
uint256 internal constant NEG_INVERTED_DENOM_4_LOC = 0x920;
uint256 internal constant NEG_INVERTED_DENOM_5_LOC = 0x940;
uint256 internal constant NEG_INVERTED_DENOM_6_LOC = 0x960;
uint256 internal constant NEG_INVERTED_DENOM_7_LOC = 0x980;
uint256 internal constant NEG_INVERTED_DENOM_8_LOC = 0x9a0;
uint256 internal constant NEG_INVERTED_DENOM_9_LOC = 0x9c0;
uint256 internal constant NEG_INVERTED_DENOM_10_LOC = 0x9e0;
uint256 internal constant NEG_INVERTED_DENOM_11_LOC = 0xa00;
uint256 internal constant NEG_INVERTED_DENOM_12_LOC = 0xa20;
uint256 internal constant NEG_INVERTED_DENOM_13_LOC = 0xa40;

uint256 internal constant FOLD_POS_EVALUATIONS_0_LOC = 0xa60;
uint256 internal constant FOLD_POS_EVALUATIONS_1_LOC = 0xa80;
uint256 internal constant FOLD_POS_EVALUATIONS_2_LOC = 0xaa0;
uint256 internal constant FOLD_POS_EVALUATIONS_3_LOC = 0xac0;
uint256 internal constant FOLD_POS_EVALUATIONS_4_LOC = 0xae0;
uint256 internal constant FOLD_POS_EVALUATIONS_5_LOC = 0xb00;
uint256 internal constant FOLD_POS_EVALUATIONS_6_LOC = 0xb20;
uint256 internal constant FOLD_POS_EVALUATIONS_7_LOC = 0xb40;
uint256 internal constant FOLD_POS_EVALUATIONS_8_LOC = 0xb60;
uint256 internal constant FOLD_POS_EVALUATIONS_9_LOC = 0xb80;
uint256 internal constant FOLD_POS_EVALUATIONS_10_LOC = 0xba0;
uint256 internal constant FOLD_POS_EVALUATIONS_11_LOC = 0xbc0;
uint256 internal constant FOLD_POS_EVALUATIONS_12_LOC = 0xbe0;
uint256 internal constant FOLD_POS_EVALUATIONS_13_LOC = 0xc00;
...
uint256 internal constant LATER_SCRATCH_SPACE = 0x4b00;

/*´:°•.°+.*•´.*:˚.°*.˚•´.°:°•.°•.*•´.*:˚.°*.˚•´.°:°•.°+.*•´.*:*/
/*                                         Temporary space                                          */
/*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
uint256 internal constant TEMP_0_LOC = 0x4b20;
uint256 internal constant TEMP_1_LOC = 0x4b40;
uint256 internal constant TEMP_2_LOC = 0x4b60;
uint256 internal constant TEMP_3_LOC = 0x4b80;
uint256 internal constant TEMP_4_LOC = 0x4ba0;
uint256 internal constant TEMP_5_LOC = 0x4bc0;
uint256 internal constant TEMP_6_LOC = 0x4be0;
uint256 internal constant TEMP_7_LOC = 0x4c00;
uint256 internal constant TEMP_8_LOC = 0x4c20;
uint256 internal constant TEMP_9_LOC = 0x4c40;
uint256 internal constant TEMP_10_LOC = 0x4c60;
uint256 internal constant TEMP_11_LOC = 0x4c80;
uint256 internal constant TEMP_12_LOC = 0x4ca0;
uint256 internal constant TEMP_13_LOC = 0x4cc0;
uint256 internal constant TEMP_14_LOC = 0x4ce0;
uint256 internal constant TEMP_15_LOC = 0x4d00;
uint256 internal constant TEMP_16_LOC = 0x4d20;
uint256 internal constant TEMP_17_LOC = 0x4d40;
uint256 internal constant TEMP_18_LOC = 0x4d60;
uint256 internal constant TEMP_19_LOC = 0x4d80;
uint256 internal constant TEMP_20_LOC = 0x4da0;
uint256 internal constant TEMP_21_LOC = 0x4dc0;
uint256 internal constant TEMP_22_LOC = 0x4de0;
uint256 internal constant TEMP_23_LOC = 0x4e00;
uint256 internal constant TEMP_24_LOC = 0x4e20;
uint256 internal constant TEMP_25_LOC = 0x4e40;
uint256 internal constant TEMP_26_LOC = 0x4e60;
uint256 internal constant TEMP_27_LOC = 0x4e80;
uint256 internal constant TEMP_28_LOC = 0x4ea0;
uint256 internal constant TEMP_29_LOC = 0x4ec0;
uint256 internal constant TEMP_30_LOC = 0x4ee0;
uint256 internal constant TEMP_31_LOC = 0x4f00;
uint256 internal constant TEMP_32_LOC = 0x4f20;
uint256 internal constant TEMP_33_LOC = 0x4f40;
uint256 internal constant TEMP_34_LOC = 0x4f60;
uint256 internal constant TEMP_35_LOC = 0x4f80;
uint256 internal constant TEMP_36_LOC = 0x4fa0;
uint256 internal constant TEMP_37_LOC = 0x4fc0;
uint256 internal constant TEMP_38_LOC = 0x4fe0;
uint256 internal constant TEMP_39_LOC = 0x5000;
uint256 internal constant TEMP_40_LOC = 0x5020;
uint256 internal constant TEMP_41_LOC = 0x5040;
...
// {{ SECTION_END MEMORY_LAYOUT }}
        ...
        returns (bool)
    {
        ...
        assembly {
            ...
            function loadVk() {
                mstore(Q_L_X_LOC, 0x0e86f642563dfa4af95c119a8bf34850ebd816f1497409b3c7040bef849f362f)
                mstore(Q_L_Y_LOC, 0x0e8634c60ba2ff7a177ee33bb0b47bc88466c29d21f8a31d5da1a96d978c3b4b)
                mstore(Q_R_X_LOC, 0x2de228087d57cd6cd36bb56f9f3baeb8eded972d785fe7d2001f858158b64464)
                mstore(Q_R_Y_LOC, 0x2d9b0931fc930537b6e9220cc9867f9ac287ad7d8c35c7a83b335eb9131e65a3)
                mstore(Q_O_X_LOC, 0x26ab8b8feb06063b17828d0899608f9845b44728f54fe461909a273f5422e29b)
                mstore(Q_O_Y_LOC, 0x28ab38df1c3cd6ed7eedc82547ddca464f7cf60ece769caadee6bae1f259b407)
                mstore(Q_4_X_LOC, 0x25dec9417363cfa6fa35e47557a044f27c2cc19f4a9d2a2bc264f9087a2037bc)
                mstore(Q_4_Y_LOC, 0x280735553deed9489d0d305cd08ebec81a5f6fc1f279db1169edc91e1c19f45d)
                mstore(Q_M_X_LOC, 0x0dac2302d32f891981c9020474dbe7f7984bf6421ac00892ce729d92800be6d7)
                mstore(Q_M_Y_LOC, 0x0ae68a5df2296944f4b818d758374ff63a3d3bfd42c57b44f7555885dac263fa)
                mstore(Q_C_X_LOC, 0x16a4a478217b0208b7d2f71122bfef96b5f614d4db4d23ba78afa439c0d00c0c)
                mstore(Q_C_Y_LOC, 0x10bac4ae7e61cfcf9c5836fffdcd205bb592082df081d6fa902171f7bb793239)
                ...
                mstore(Q_ARITH_X_LOC, 0x1cc1262efd27e7a02dd21cabae51308118a9e8f474a9476e8f108e4c39401952)
                mstore(Q_ARITH_Y_LOC, 0x2304a81a5a80d81e6d59f17fb4b7e9c49a1da11836aa1c788a8ca804d8b0d48f)
                mstore(Q_DELTA_RANGE_X_LOC, 0x1f3c91119cca4e8a87d972dd1c0ea6545679586f831b48a0b83c11a209762122)
                mstore(Q_DELTA_RANGE_Y_LOC, 0x2496fd9d5f39fb05f446fc36fb559768938b0168a2f7dc579d88e5763524f299)
                mstore(Q_ELLIPTIC_X_LOC, 0x12a33132b7d74c8037fb090853d0ea390efc057967ef1c803c4a0ca8e9daddca)
                mstore(Q_ELLIPTIC_Y_LOC, 0x10fc93843237c5c915e4c81e7ffaa95c851ed229ac3eb96e41b623a6146fbc2e)
                mstore(Q_MEMORY_X_LOC, 0x114a838f6494087bf74a036b19bb72d82ff060fd486d3d24df5eeb84c760a7c0)
                mstore(Q_MEMORY_Y_LOC, 0x1ee1c333755ab8b4241974833ae297cf5e97559fd26de19c208c674e25eb7e5f)
                mstore(Q_NNF_X_LOC, 0x2ad245ac74c2487b27280007ebb61024a4c2948122cacb8d118e8e53518250a8)
                mstore(Q_NNF_Y_LOC, 0x003f5934795076588b46a54f6eae2f609af42b496d101bbd996cc4d02f54c680)
                mstore(Q_POSEIDON_2_EXTERNAL_X_LOC, 0x0efed312f80616180501b18eab3b9d4631168d11995c8df438867c794d8b3104)
                mstore(Q_POSEIDON_2_EXTERNAL_Y_LOC, 0x1c535fea33d9084091969c08f95fb2f7173b87e5813317706aa03abf23366e80)
                mstore(Q_POSEIDON_2_INTERNAL_X_LOC, 0x2282a8d553f8a7cb657ca369f50f4fd7c63fcb936165dbeed0e21cca251f1363)
                mstore(Q_POSEIDON_2_INTERNAL_Y_LOC, 0x1ce6b2e28e1f869e8899235c48127ad92d560016d0b2aff163a5e133216e44d9)
                mstore(SIGMA_1_X_LOC, 0x0f8652b90285d4b4b271d5439d65f96e6d1dc9b978fd44076ff974dd25535f53)
                mstore(SIGMA_1_Y_LOC, 0x0f3bdf540a45a67e1ab1053e3fb69043fd215031c3d29e62a14a2157ab7df3d1)
                mstore(SIGMA_2_X_LOC, 0x033c59df1b7b341137bf14412f70bdd1236574c5d0eb71e932302542f2a42fbf)
                mstore(SIGMA_2_Y_LOC, 0x035f15d8be61beb8bf82f9a192dbd3aa6bc5b5353cfaf4c0402dc9d1cb329a47)
                mstore(SIGMA_3_X_LOC, 0x25dca3d69e81f47c4b209e7235770806540ede5fe61aac5d841a453fb4d8368c)
                mstore(SIGMA_3_Y_LOC, 0x17ab499d524d31f089a12bd28591cb7a533e35ed3ad4f937cdfe5e004f2f7927)
                mstore(SIGMA_4_X_LOC, 0x2d9aa81e0992a4282a6471324515d7e2b4a2633b79a85ffb33451daa2d042bde)
                mstore(SIGMA_4_Y_LOC, 0x2cca993c5761c7f29551d1ac115dc9fec85174277b527b2c8a5a2cd5ffe8e6c9)
                ...
                mstore(ID_1_X_LOC, 0x0b227ad96fa703f88beb70f8f86769ca2e3f051c862a0b1f67395238c31b8234)
                mstore(ID_1_Y_LOC, 0x0312d1db7ece6d2545b7558e7d3038613520b93aabc66440cca0bf7e942094ee)
                mstore(ID_2_X_LOC, 0x1023e7fc28e21366e81e262e2a63247050cd8c0af3ecb0a22b727e82eaf58474)
                mstore(ID_2_Y_LOC, 0x14b3627325f8f705d49867bf9357d4fe96de511fbb47b50530df49417f324e43)
                mstore(ID_3_X_LOC, 0x0057572cde63a1dd0b79bf9ca9f80e19d60c998e1ca85c891b31cb066c24da05)
                mstore(ID_3_Y_LOC, 0x2544a972368aeca4526f6b493fa5278e14414a86ddb56e90aca410345e71b9f4)
                mstore(ID_4_X_LOC, 0x1e9432ca8c323ee7d9971241eb0d5caad9be9bfc0d0b131b37f549f84ff9deac)
                mstore(ID_4_Y_LOC, 0x279719fa4dfe0237ebb9031aec55f5e90e9fcfa1006f536b6c209d076d0dcfdf)
                ...
                mstore(LAGRANGE_LAST_X_LOC, 0x0c300f3a423787258190394e295bdc748bec73d006d2594be3a936ecbb07ab63)
                mstore(LAGRANGE_LAST_Y_LOC, 0x11bbdbe872eb15b60aa5e9bc75885e3ffe2b55290f3455129f9e7f55a8a3fec9)
            }
...

            {
                ...
                mcopy(0x20, GEMINI_A_EVAL_0, 0x1c0)
                prev_challenge := mod(keccak256(0x00, 0x1e0), p)
                mstore(0x00, prev_challenge)
            ...
            let store_off := INVERTED_CHALLENEGE_POW_MINUS_U_13_LOC
            let pow_off := POWERS_OF_EVALUATION_CHALLENGE_13_LOC
            let sumcheck_u_off := SUM_U_CHALLENGE_13
...
// {{ UNROLL_SECTION_END COLLECT_INVERSES }}
            ...
            // Compute fold pos evaluations
            {
                ...
                let inverted_chall_pow_minus_u_loc := INVERTED_CHALLENEGE_POW_MINUS_U_13_LOC
